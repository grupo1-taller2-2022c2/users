...
def upgrade() -> None:
    op.bulk_insert(
        users_models.User.__table__,
        [
            {
                "email": "agus_su@gmail.com",
    ...
    op.bulk_insert(
        passengers_models.Passenger.__table__,
        [
            {"user_id": 1, "ratings": 4},
            {"user_id": 2, "ratings": 2},
            {"user_id": 3, "ratings": 3},
    ...
    op.bulk_insert(
        passengers_models.Address.__table__,
        [
            {"user_id": 1, "street_name": "Salta", "street_number": 1200},
            {"user_id": 2, "street_name": "Jujuy", "street_number": 2200},
            {"user_id": 3, "street_name": "Formosa", "street_number": 3300},
            {"user_id": 4, "street_name": "Catamarca", "street_number": 5400},
            {"user_id": 5, "street_name": "Cordoba", "street_number": 9100},
        ],
    )

    op.bulk_insert(
        drivers_models.Driver.__table__,
        [
    ...
    op.bulk_insert(
        drivers_models.Vehicle.__table__,
        [
            {"user_id": 2, "licence_plate": "AA314CC", "model": "Ford Mustang"},
